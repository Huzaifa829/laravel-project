...
Frames.init({
    publicKey:"pk_idkmhdq4y3tdxslabhzqlxaq7a7",
...
function showPaymentMethodIcon(parent, pm) {
  ...
  if (pm) {
    ...
    logo.setAttribute("src", "payment/images/card-icons/" + name + ".svg");
...
function setDefaultIcon(el) {
  ...
  logo.setAttribute("src", "payment/images/card-icons/" + logos[el].src + ".svg");
...
function setDefaultErrorIcon(el) {
  var selector = "icon-" + el;
  var logo = document.getElementById(selector);
  logo.setAttribute("src", "payment/images/card-icons/" + logos[el].src + "-error.svg");
  logo.setAttribute("alt", logos[el].alt);
}
