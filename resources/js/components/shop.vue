                                                                ...
                                                                <label class="filter-list__item">
                                                                    <span class="input-check filter-list__input">
                                                                        <span class="input-check__body">
                                                                            <input class="input-check__input" type="checkbox" value="{{$brand['id']}}"/>
                                                                    ...
                                                                    <span class="filter-list__title">{{ $brand['title'] }} </span>
                                                                </label>
                                                                @endforeach
                                                            </div>
                                                        </div>
                    ...
                    <div class="products-view">
                        <div class="products-view__options view-options view-options--offcanvas--mobile">
                            <div class="view-options__body">
                                ...
                                <div class="view-options__legend">Showing {{$collectionproduct->count()}} of {{ $collectionproduct->total() }} products</div>
