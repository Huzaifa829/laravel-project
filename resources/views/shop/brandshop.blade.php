                                            ...
                                            <div class="product-card">
                                                <div class="product-card__image">
                                                    <div class="image image--type--product">
                                                        <a href="{{ route('single-product', $product->slug) }}" class="image__body">
                                                            <img class="image__tag" src="{{ URL::asset('https://app.fa-bt.com/') }}{{ $product->thumbnail }}" alt="{{$product->productname}}"/>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-card__info">
                                                    ...
                                                    <div class="product-card__name">
                                                        <div>
                                                            <a href="{{ route('single-product', $product->slug) }}">{{ $product->productname }}</a>
                                                        </div>
                                                    </div>
