@extends('layout.main')
@section('title')
    {{ $mainshopproducts->metatitle }}
@endsection
@section('content')

    <div class="block-split block-split--has-sidebar">
        <div class="container">
            <h3 class="mt-4 mb-4" style="text-align: center;">{{$maincategory->title}}</h3>
                                        ...
                                        <div class="widget-filters__item">
                                            <div class="filter filter--opened" data-collapse-item>
                                                <button type="button" class="filter__title"
                                                    data-collapse-trigger>Categories
                                                                ...
                                                                <div class="filter-list__list">
                                                                    @foreach ($collectionbrand as $brand)
                                                                        <label class="filter-list__item">
                                                                            ...
                                                                            <span
                                                                                class="filter-list__title">{{ $brand['title'] }}
                                                                            </span>
                                                                        </label>
                                                                    @endforeach
                                                                </div>
                        ...
                        <div class="products-view">
                            <div class="products-view__options view-options view-options--offcanvas--mobile">
                                <div class="view-options__body">
                                    ...
                                    <div class="view-options__legend">Showing {{ $collectionproduct->count() }} of
                                        {{ $collectionproduct->total() }} products</div>
                                                ...
                                                <div class="product-card">
                                                        ...
                                                        <div class="image image--type--product">
                                                            <a href="{{ route('single-product', $product['slug']) }}"
                                                                ...
                                                                <img class="image__tag"
                                                                    src="{{ URL::asset('https://app.fa-bt.com/') }}{{ $product['thumbnail'] }}"
                                                                    alt="" />
                                                            </a>
                                                        </div>
                                                        <div
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta">
                                                            <span
                                                                class="product-card__meta-title">MFR:</span>{{ strtoupper($product['mfr']) }}
                                                        </div>
                                                    ...
                                                    <div class="product-card__footer">
                                                        <div class="product-card__prices">
                                                            <div class="product-card__price product-card__price--current">
                                                                AED {{ number_format($product['price'], 2) }}</div>
                                                        </div>
                                                        ...
                                                        <form action="{{ route('product.addtowishlist') }}"
                                                            method="POST">
                                                            {{ csrf_field() }}
                            ...
                            <div class="products-view__pagination">
                                ...
                                Showing {{ $collectionproduct->count() }} of {{ $collectionproduct->total() }} products
                            </div>
                        </div>
                    </div>
                </div>
